    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String userEmail_text = userEmail.getText().toString();
                String userPass_text = userPass.getText().toString();
                signIn(userEmail_text,userPass_text);
                Log.d("TAG", userPass_text+"Value is: " + userEmail_text);
            }
        });
